...
const NotFound = () => {
  return (
    <div className="rn-page flex min-h-screen flex-col">
      <section className="rn-section flex flex-1 flex-col items-center justify-center bg-midnight pt-28 text-center sm:pt-32">
        <div className="rn-container max-w-md">
