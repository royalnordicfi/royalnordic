    ...
    >
      ...
      <div className="relative z-20 text-center px-3 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-luxury font-bold mb-4 sm:mb-6 leading-tight">
          ...
          <span className="block text-lg sm:text-xl md:text-3xl lg:text-4xl mt-2 sm:mt-4 text-gray-300 font-elegant font-light italic">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button 
            ...
            className="bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 rounded-full font-elegant font-bold text-base sm:text-lg md:text-xl transition-all duration-500 transform hover:scale-110 shadow-2xl hover:shadow-emerald-500/40 tracking-widest border-2 border-emerald-500/50"
            style={{
