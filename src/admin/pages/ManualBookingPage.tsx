...
import { createManualBooking, fetchProducts } from '../adminApi'
import type { BookingSource, PaymentStatus, Product } from '../types'
...
export default function ManualBookingPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-600">Phone / WhatsApp / email / walk-in — under two minutes.</p>
      ...
      <form onSubmit={submit} className="space-y-3 bg-white border border-gray-200 rounded-lg p-4">
